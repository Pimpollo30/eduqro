    ...
    return Container(
      ...
      child: Column(
        ...
        Text("Nombre de la carrera",
          ...
          SizedBox(height: 8,),
        Text("Propósito del programa educativo",
          style: TextStyle(
            fontWeight: FontWeight.bold,
            color: Colors.black87,
            fontSize:16,
